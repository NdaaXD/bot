...
global.owner = ['6288239928939'] // Put your number here
global.mods = [] // Want some help?
global.prems = ['6285294959195'] // Premium user has unlimited limit
...
global.prefix = new RegExp('^[' + (opts['prefix'] || '‎ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz\\/i!#$%*,()@1234567890¡¿\\-+£¢€¥^°=¶∆×÷π√✓©®:;?&.') + ']')
...
conn.welcome = 'Halo @user!\n\nSelamat datang di grup\n*@subject*\n\nJangan Lupa Intronya ya!'
conn.bye = 'Al-Fatihah buat yang Left!\n\n@user'
...
if (!global.support.convert) conn.logger.warn('BOT POWERED BY DHAMZ BOT')
